...
__export(index_exports, {
  ...
  MemoryApiKeyStore: () => MemoryApiKeyStore,
  ...
  buildOAuth2Metadata: () => buildOAuth2Metadata,
  buildOauthDiscoveryDocument: () => buildOauthDiscoveryDocument,
  buildPaymentRequired: () => buildPaymentRequired,
  buildRequirements: () => buildRequirements,
  buildWwwAuthenticate: () => buildWwwAuthenticate,
  checkRequireAuth: () => checkRequireAuth,
  computeCodeChallenge: () => computeCodeChallenge,
  createAgUiEmitter: () => createAgUiEmitter,
  ...
  encodeEvents: () => encodeEvents,
  encodePaymentRequired: () => encodePaymentRequired,
  evaluateAuthz: () => evaluateAuthz,
  exchangeCode: () => exchangeCode,
  extractAndVerifyToken: () => extractAndVerifyToken,
  extractBearerToken: () => extractBearerToken,
  extractClaims: () => extractClaims,
  extractPaymentRequirements: () => extractPaymentRequirements,
  formatError: () => formatError,
  formatToolName: () => formatToolName,
  generateAIManifest: () => generateAIManifest,
  generateAgentCard: () => generateAgentCard,
  generateAgentsTxt: () => generateAgentsTxt,
  generateAllDiscovery: () => generateAllDiscovery,
  ...
  generateServerInfo: () => generateServerInfo,
  generateStandaloneAgentsTxt: () => generateAgentsTxt2,
  generateToolDefinitions: () => generateToolDefinitions,
  generateUnifiedAIManifest: () => generateUnifiedAIManifest,
  generateUnifiedAgentCard: () => generateUnifiedAgentCard,
  generateUnifiedLlmsFullTxt: () => generateUnifiedLlmsFullTxt,
  generateUnifiedLlmsTxt: () => generateUnifiedLlmsTxt,
  handleJsonRpc: () => handleJsonRpc,
  handleOAuth2: () => handleOAuth2,
  handleOptionalIdentity: () => handleOptionalIdentity,
  handleRequireIdentity: () => handleRequireIdentity,
  handleX402: () => handleX402,
  hasScope: () => hasScope,
  isAgentAllowed: () => isAgentAllowed,
  isFormatEnabled: () => isFormatEnabled,
  isPaymentRequired: () => isPaymentRequired,
  isSpiffeTrusted: () => isSpiffeTrusted,
  matchRoute: () => matchRoute,
  notFoundError: () => notFoundError,
  parseAgentsTxt: () => parseAgentsTxt,
  parseSpiffeId: () => parseSpiffeId,
  parseToolName: () => parseToolName,
  rateLimitError: () => rateLimitError,
  refreshAccessToken: () => refreshAccessToken,
  resolvePrice: () => resolvePrice,
  validateAccessToken: () => validateAccessToken,
  validateAgentCard: () => validateAgentCard,
...
function createAgUiEmitter(write, options = {}) {
  const threadId = options.threadId ?? (0, import_crypto.randomUUID)();
  const runId = options.runId ?? (0, import_crypto.randomUUID)();
  ...
  return {
    ...
    textStart(role = "assistant", messageId) {
      currentMessageId = messageId ?? (0, import_crypto.randomUUID)();
    ...
    toolCallStart(toolCallName, toolCallId, parentMessageId) {
      currentToolCallId = toolCallId ?? (0, import_crypto.randomUUID)();
