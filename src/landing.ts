...
function renderDemoCard(d: DemoCardData): string {
  ...
  return [
    ...
    "      <h3>" + d.name + "</h3>",
    "    </div>",
    '    <span class="score-badge">Agent-Ready Score: 100/100</span>',
    "  </div>",
...
const demos: DemoCardData[] = [
  ...
  },
  {
    icon: "🤝",
    name: "CRM API",
    desc: "Contacts, companies, deals, pipeline, and activity tracking",
    prefix: "/demo/crm",
    endpoints: ["GET /contacts", "GET /companies", "GET /deals", "POST /deals", "GET /pipeline", "GET /activities"],
  },
  {
    icon: "📝",
